...
Como puede verse, nuestros algoritmos arrojan resultados muy similares a Opencv. Por lo que consideramos que su implementacion es correcta.
...
\begin{figure}[H]
    \centering
    \subfloat[Metodo 1]{{\includegraphics[width=5cm]{fotos/alfanum/k1_1.png} }}
    \qquad
    \subfloat[Metodo 2]{{\includegraphics[width=5cm]{fotos/alfanum/k1_2.png} }}
    \qquad
    \subfloat[Metodo 3]{{\includegraphics[width=5cm]{fotos/alfanum/k1_3.png} }}
...
\begin{figure}[H]
    \centering
    \subfloat[Metodo 1]{{\includegraphics[width=5cm]{fotos/alfanum/k2_1.png} }}
    \qquad
    \subfloat[Metodo 2]{{\includegraphics[width=5cm]{fotos/alfanum/k2_2.png} }}
    \qquad
    \subfloat[Metodo 3]{{\includegraphics[width=5cm]{fotos/alfanum/k2_3.png} }}
...
\begin{figure}[H]
    \centering
    \subfloat[Metodo 1]{{\includegraphics[width=5cm]{fotos/alfanum/k5_1.png} }}
    \qquad
    \subfloat[Metodo 2]{{\includegraphics[width=5cm]{fotos/alfanum/k5_2.png} }}
    \qquad
    \subfloat[Metodo 3]{{\includegraphics[width=5cm]{fotos/alfanum/k5_3.png} }}
...
\begin{figure}[H]
    \centering
    \subfloat[Metodo 1]{{\includegraphics[width=5cm]{fotos/paisaje/k10_1.jpg} }}%
    \qquad
    \subfloat[Metodo 2]{{\includegraphics[width=5cm]{fotos/paisaje/k10_2.jpg} }}%
    \qquad
    \subfloat[Metodo 3]{{\includegraphics[width=5cm]{fotos/paisaje/k10_3.jpg} }}%
    \caption{Comparacón de metodos para $k = 3$}%
    \label{fig:example}%
\end{figure}
...
Como puede verse, el metodo 2 continua siendo el que produce menos ECM y el que obtiene mejor PSNR incluso para estos niveles altisimos de k.
...
\begin{figure}[H]
    \centering
    \subfloat[Metodo 1]{{\includegraphics[width=5cm]{fotos/rostro/k10_1.jpg} }}%
    \qquad
    \subfloat[Metodo 2]{{\includegraphics[width=5cm]{fotos/rostro/k10_2.jpg} }}%
    \qquad
    \subfloat[Metodo 3]{{\includegraphics[width=5cm]{fotos/rostro/k10_3.jpg} }}%
    \caption{Comparacón de metodos para $k = 3$}%
    \label{fig:example}%
\end{figure}
