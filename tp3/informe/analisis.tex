...
Una vez mas, vuelve a repetirse el resultado que habiamos obtenido para valores elevados de $k$ en imagenes anteriores. De nuevo el metodo de los vecinos pierde frente a los demas por una gran diferencia (tanto 'visual' como a nivel numerico). Las diferencias entre el metodo bilineal y el metodo de splines, repito exactamente los resultados anteriores.
